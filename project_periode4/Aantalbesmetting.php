    ...
    <div class="w3-row-padding w3-padding-64 w3-container">
        <div class="w3-content">
            <div class="w3-twothird">
                    ...
                    <h4 class="w3-padding-32">er is <?php echo $aantal ?>  besmetting in de gemeente <?php echo $plaats ?></h4>
    ...
    <div class="w3-row-padding w3-padding-64 w3-container">
        <div class="w3-content">
            <div class="w3-twothird">
                    ...
                    <h4 class="w3-padding-32">er zijn <?php echo $aantal ?> aantal besmettingen in de provincie <?php echo $plaats ?></h4>
